...
class _TicketPageState extends State<TicketPage> {
  ...
  int selectedTypes = 0, animateDuration = 400;
  bool onExpand = false, minUnits = false, animate = false;
                              ...
                              child: ScrollbarTheme(
                                ...
                                child: Scrollbar(
                                  ...
                                  child: ListView(
                                    ...
                                    padding: const EdgeInsets.only(right: 14, left: 28, top: 24),
                                    shrinkWrap: true,
                                    ...
                                    children: List.generate(tickets.length, (index) {
                                      ...
                                      return Padding(
                                        ...
                                        child: AnimatedOpacity(
                                          opacity: animate ? 1 : 0,
                                          curve: Curves.easeInOutCubic,
                                          duration: Duration(milliseconds: animateDuration + 50),
                                          child: AnimatedSlide(
                                            offset: Offset(0, animate ? 0 : 2),
                                            curve: Curves.easeOutCubic,
